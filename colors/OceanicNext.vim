...
"}}}
" {{{ Colors
  let s:base00 = ['#1b2b34', 'None']
  let s:base01 = ['#343d46', 'None']
  let s:base02 = ['#4f5b66', '240']
  let s:base03 = ['#65737e', '243']
  let s:base04 = ['#a7adba', '145']
  let s:base05 = ['#c0c5ce', '251']
  let s:base06 = ['#cdd3de', '252']
  let s:base07 = ['#d8dee9', 'None']
...
" {{{ call s::hi(group, fg, bg, gui, guisp)
  ...
  call s:hi('SignatureMarkText',                 s:pink, '',       '',          '')
  ...
  " call s:hi('DiffAdd',                            s:green,  s:green, s:bold,      '')
  ...
  call s:hi('ALEErrorSign',                       s:red,    s:base00, '', '')
  call s:hi('ALEError',                           s:red,    s:base00, 'underline', '')
  call s:hi('ALEErrorLine',                       '',       s:base00, s:bold,      '')
  call s:hi('ALEErrorSignLineNr',                 '',       s:base00, s:bold,      '')

  call s:hi('ALEWarningSign',                     s:orange, s:base00, '', '')
  call s:hi('ALEWarning',                         '',       s:base00, 'underline', '')
  ...
  call s:hi('GitGutterAdd',                       '',  s:green, s:bold,      '')
  call s:hi('GitGutterChange',                    '',   s:blue, s:bold,      '')
  call s:hi('GitGutterDelete',                    '',    s:red, s:bold,      '')
  call s:hi('GitGutterChangeDelete',              '', s:purple, s:bold,      '')
